...
//		el.style.width = this.elEditingAreaContainer.style.width || (this.elEditingAreaContainer.offsetWidth+"px");
	...
	createCoverDiv : function(){
		...
		this.elResizingBoard.style.background = "#202B31";
...
nhn.husky.SE2M_FontColor = jindo.$Class({
	...
	_assignHTMLElements : function(elAppContainer){
		...
		this._setLastUsedFontColor("#202B31");
	},
	...
	getLastUsedFontColor : function(){
		return (!!this.sLastUsedColor) ? this.sLastUsedColor : '#202B31';
	}
});
//{
/**
 ...
 nhn.ColorPicker = jindo.$Class({
	...
	_paintColWithFilter : function() {
		...
		jindo.$Element("<div>").css({
			...
			width    : "100%",
			height   : "100%",
			filter : "progid:DXImageTransform.Microsoft.Gradient(GradientType=0,StartColorStr='#202B3100',EndColorStr='#FF000000')"
		}).appendTo(this.elem);
	},
	...
	_paintOneWithFilter : function() {
		...
		jindo.$Element("<div>").css({
			...
			width    : "50%",
			height   : "100%",
			filter : "progid:DXImageTransform.Microsoft.Gradient(GradientType=1,StartColorStr='#202B3100',EndColorStr='#FF000000')"
		}).appendTo(this.elem);
	},
...
//			jindo.$Element(aCellInfo[0]).css("height", aCellInfo[2]);
	...
	_createCellResizeGrip : function(){
		...
		try{
			this.elTmp.innerHTML = '<div style="position:absolute; overflow:hidden; z-index: 99; "><div onmousedown="return false" style="background-color:#202B31;filter:alpha(opacity=0);opacity:0.0;-moz-opacity:0.0;-khtml-opacity:0.0;cursor: col-resize; left: 0px; top: 0px; width: 100%; height: 100%;font-size:1px;z-index: 999; "></div></div>';
...
*/
	...
	// 11
	{
		...
		ht1stRowStyle : {
			padding				: "3px 4px 2px",
			borderTop			: "1px solid #202B31",
			borderBottom		: "1px solid #202B31",
