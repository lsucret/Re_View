 ...
 * @author cielo
 * @See nhn.husky.SE2M_Configuration @ 팝업 마크업은 SimplePhotoUpload.html과 SimplePhotoUpload_html5.html이
 *      있습니다.
 */
...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function() {
		...
		this.htPopupOption.sProperties = "left=100,top=50,width=420,height=360,scrollbars=yes,location=no,status=0,resizable=no";
	...
	/**
	 * 서비스별로 팝업에 parameter를 추가하여 URL을 생성하는 함수 nhn.husky.SE2M_AttachQuickPhoto.prototype.makePopupURL로
	 * 덮어써서 사용하시면 됨.
	 */
